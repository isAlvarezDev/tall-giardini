    ...
    <header
      ...
      style={{
        background: hoverEffect.active
          ? `radial-gradient(circle at ${hoverEffect.x}% ${
              hoverEffect.y
            }%, rgba(0, 140, 255, 0.15), rgba(10, 10, 10, ${
              scrolled ? "0.95" : "0.85"
            }) 30%)`
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-between items-center relative">
          ...
          <div className="flex items-center group">
            ...
            >
              <div className="relative">
                <img
                  src="./logo.png"
                  alt="Tall Giardini Logo"
                  className="rounded-full w-10 h-10 sm:w-12 sm:h-12 border-none z-10 relative transition-transform duration-500 "
                />
              </div>
              ...
              <div key={item.href} className="relative group perspective">
                ...
                >
                  ...
                  <span
                    ...
                    style={{
                      background:
                        "radial-gradient(circle closest-side, rgba(37, 99, 235, 0.3), transparent)",
          ...
          <a
            href="#contact"
            className="hidden lg:flex items-center px-6 py-2.5 relative overflow-hidden group rounded-full transition-all duration-300 bg-gradient-to-r from-blue-600 to-purple-600 shadow-lg"
          >
            <Sparkles className="w-4 h-5 mr-2 relative text-white group-hover:animate-pulse" />
          ...
          >
            ...
            >
              ...
              <div className="flex-1 flex flex-col justify-center items-center space-y-8 px-8">
                <a
                  href="#services"
                  className="text-2xl text-center text-white font-medium hover:text-blue-400 transition-colors"
                  onClick={closeMenu}
                >
                  Servicios
                </a>
